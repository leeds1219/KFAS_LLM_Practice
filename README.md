...
| **2** | **SLM (local)** | Download and run a *small* model *inside* Colab, offline. | [![Open In Colab](https://colab.research.google.com/assets/1gO3gQryUrioZEpIVkghxCalT5w-aXgzR?usp=sharing)] |
